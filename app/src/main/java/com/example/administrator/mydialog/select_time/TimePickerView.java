...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        initWheelTime(context, timePickerView);
    }
...
//
//    public void setGravityRight_(int gravity){
//        this.gravityRight = gravity;
//    }
//
//    public void setGravityLeft_(int gravity){
//        this.gravityLeft = gravity;
//    }
//
//    public void setGravityRightBool_(boolean b){
//        this.gravityRightBool = b;
//    }
//
//    public void setGravityLeftBool_(boolean b){
//        this.gravityLeftBool = b;
//    }

    private void initWheelTime(Context context,LinearLayout timePickerView) {
        wheelTime = new WheelTime(context, timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
...
//        wheelTime.setGravityRight(gravityRight);
//        wheelTime.setGravityLeft(gravityLeft);
//        wheelTime.setGravityRightBool(gravityRightBool);
//        wheelTime.setGravityLeftBool(gravityLeftBool);
