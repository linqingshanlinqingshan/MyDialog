...
public class WheelTime {
    ...
    public WheelTime(Context context,View view, boolean[] type, int gravity, int textSize) {
        super();
    ...
    private int gravityRight = Gravity.RIGHT;
    private boolean gravityRightBool = true;
    private int gravityLeft = Gravity.LEFT;
    private boolean gravityLeftBool = true;

//    public void setGravityRight(int gravity){
//        this.gravityRight = gravity;
//    }
//
//    public void setGravityLeft(int gravity){
//        this.gravityLeft = gravity;
//    }
//
//    public void setGravityRightBool(boolean b){
//        this.gravityRightBool = b;
//    }
//
//    public void setGravityLeftBool(boolean b){
//        this.gravityLeftBool = b;
//    }
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        wv_year.setVisibility(type[0] ? View.VISIBLE : View.INVISIBLE);
        wv_month.setVisibility(type[1] ? View.VISIBLE : View.INVISIBLE);
        wv_day.setVisibility(type[2] ? View.VISIBLE : View.INVISIBLE);
        wv_hours.setVisibility(type[3] ? View.VISIBLE : View.INVISIBLE);
        wv_minutes.setVisibility(type[4] ? View.VISIBLE : View.INVISIBLE);
        wv_seconds.setVisibility(type[5] ? View.VISIBLE : View.INVISIBLE);
        setContentTextSize();
    }
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
        ...
        wv_year.setCurrentItem(year - startYear);// 初始化时显示的数据
        wv_year.setGravity(gravity);  //-------------------------------------------------------->>>>设置固定


//        if(gravityRightBool) {
////            wv_year.setPadding(0, 0, ScreenUtil.dip2px(mContext, 20), 0);
//        }
        // 月
        wv_month = (WheelView) view.findViewById(R.id.month);
        ...
        wv_day.setGravity(gravity);  //-------------------------------------------------------->>>>设置固定


//        if(gravityLeftBool){
//            wv_day.setPadding(ScreenUtil.dip2px(mContext,20),0,0,0);
//        }
        //时
        wv_hours = (WheelView) view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
