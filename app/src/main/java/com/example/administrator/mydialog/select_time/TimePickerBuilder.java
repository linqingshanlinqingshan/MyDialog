...
public class TimePickerBuilder {
    ...
    public TimePickerView build() {
        TimePickerView timePickerView = new TimePickerView(mPickerOptions);

//        timePickerView.setGravityRight_(gravityRight);
//        timePickerView.setGravityLeft_(gravityLeft);
//        timePickerView.setGravityRightBool_(gravityRightBool);
//        timePickerView.setGravityLeftBool_(gravityLeftBool);
